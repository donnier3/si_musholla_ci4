                        ...
                        <div class="card-columns-fluid">
                            <div class="card">
                                ...
                                <div class="card-body text-justify">
                                    ...
                                    <img src="/img/budget/<?= $b['img_budget'] ?>" style="max-height: 200px; min-height:200px" class="card-img-top">
                                    <!-- </div>
                ...
                <?php foreach ($kajian as $k) : ?>
                    <div class="carousel-item-c">
                        <div class="card-box-b card-shadow news-box">
                            <div class="img-box-b">
                                <img src="img/kajian/<?= $k['img_kajian'] ?>" style="min-width: 350px !important; max-height:500px; min-height:500px !important;" class="img-fluid">
                            </div>
